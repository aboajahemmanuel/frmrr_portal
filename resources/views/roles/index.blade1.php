                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                        <div class="float-end d-none d-md-block">
                            <div class="dropdown">
                                <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="modal"
                                data-bs-target="#staticBackdrop" aria-expanded="true" style="color: white; background-color: #21336b;" >
                                    ...
                                    @foreach ($data as $key => $role)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @can('role-edit')
                                                    <a class="btn" style="color: white; background-color: #21336b;" data-bs-toggle="modal"
                                                    data-bs-target="#editrole-{{$role->id}}">Edit</a>
                                                @endcan
                                                
                                                @can('role-delete')
                                                <a class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#deleterole-{{$role->id}}">Delete</a>
                                                @endcan
                                            </td>
                                        </tr>
                                    @endforeach
...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">Add Role
            </h5>
...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">{{ $role->name}}
            </h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal"
                aria-label="Close"></button>
        </div>
