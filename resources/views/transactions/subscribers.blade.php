                                        ...
                                        <tbody>
                                            @foreach ($data as $transaction)
                                                <tr class="nk-tb-item">
                                                    ...
                                                    {{ str_replace('May.', 'May', \Carbon\Carbon::parse($transaction->start_date)->format('M. j, Y')) }} {{ \Carbon\Carbon::parse($transaction->created_at)->format('h:i A') }}
                                                    </td>
                                                    <td class="nk-tb-col">
                                                        {{ str_replace('May.', 'May', \Carbon\Carbon::parse($transaction->end_date)->format('M. j, Y')) }} {{ \Carbon\Carbon::parse($transaction->created_at)->format('h:i A') }}
                                                    </td>
                                                    ...
                                                    <td class="nk-tb-col">
                                                        {{ str_replace('May.', 'May', \Carbon\Carbon::parse($transaction->created_at)->format('M. j, Y h:i A')) }}
