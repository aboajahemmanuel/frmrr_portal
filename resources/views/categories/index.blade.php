                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="infomation">
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-12">
                                            <label class="form-label" for="lead-name">Display On Menu</label>
                                            <div class="form-control-wrap">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body modal-body-md">
                            ...
                            <form id="editForm-{{ $category->id }}" method="POST"
                                action="{{ route('catUpdate', $category->id) }}" enctype="multipart/form-data">
                                @csrf
                                {{-- {!! Form::model($category, [
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="infomation">
                                        <div class="row gy-4">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        ...
                                                        <input value="0" hidden name="status" type="text"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="customFileLabel">Update Category
                                                        Image</label>
                                                    <div class="form-control-wrap">
                                                        <div class="custom-file">
                                                    ...
                                                    @if ($category->category_image)
                                                        <a href="public/categories/{{ $category->category_image }}
"
                                                            download="public/categories/{{ $category->category_image }}">
                                                            <h5>
                                                                <br>
                                                                <center>Click to downlaod category image
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-control-wrap">
                                                    <select class="form-control" name="display_on_menu">
                                                        ...
                                                        <option value="1"
                                                            {{ $category->display_on_menu == 1 ? 'selected' : '' }}>
                                                            Active</option>
                                                        <option value="0"
                                                            {{ $category->display_on_menu == 0 ? 'selected' : '' }}>
                                                            Inactive</option>
                                            ...
                                            {{-- <div class="col-12">
                                                ...
                                                <div class="custom-control custom-control-lg custom-switch">
                                                    <input type="checkbox" class="custom-control-input"
                                                        name="display_on_menu" id="customSwitch2-{{ $catecsxj }}">
                                                    <label class="custom-control-label" for="customSwitch2">Display On
                                                        Menu</label>
                                                </div>
                                ...
                                <div class="nk-modal py-4">
                                    ...
                                    <ul class="d-flex justify-content-center gx-4 mt-4">
                                        <li>
                                            ...
                                            <button id="deleteSubmitBtn-{{ $category->id }}" type="submit" id="deleteOrg"
