                        ...
                        <div class="nk-block-head nk-block-head-sm">
                            <div class="nk-block-between">
                                <div class="nk-block-head-content">
                                    <h3 class="nk-block-title page-title">Admin Users List</h3>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <select name="status" class="form-select form-control">
                                                            ...
                                                            <option value="0" {{ request('status') === '0' ? 'selected' : '' }}>Awaiting Approval</option>
                                                            ...
                                                            <option value="3" {{ request('status') === '3' ? 'selected' : '' }}>Awaiting Deletion</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane active" id="infomation">
                                <div class="row gy-4">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="lead-name">First Name</label>
                                            <div class="form-control-wrap">

                                                <input name="fname" type="text" class="form-control" id="lead-name"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="lead-name">Last Name</label>
                                            <div class="form-control-wrap">

                                                <input name="lname" type="text" class="form-control" id="lead-name"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="infomation">
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input disabled type="text" class="form-control" id="lead-name"
                                                        name="name" value="{{ optional($user_pending)->name ?? 'N/A' }}"
                                                        required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="open-deal" class="form-label">Email</label>
                                                    <input disabled type="text" class="form-control" id="open-deal"
                                                        name="email" value="{{ optional($user_pending)->email ?? 'N/A' }}"
                                                        required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Group</label>
                                                    <select disabled name="group_id" class="form-select form-control"
                                                        required>
                                                        <option value="">Select one</option>
                                                        @foreach ($groups as $group)
                                                            <option value="{{ $group->id }}"
