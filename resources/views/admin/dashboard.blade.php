                                                                                ...
                                                                                @if ($regulation->status != 3)
                                                                                    @if ($regulation->status != 0)
                                                                                        @can('regulation-edit')
                                                                                            ...
                                                                                            <li><a href="#"
                                                                                                    data-toggle="modal"
                                                                                                    data-target="#viewChanges-{{ $regulation->id }}"><em
                                ...
                                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                    ...
                                    <tbody>
                                        @foreach ($categories as $category)
                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    ...
                                                                    <ul class="link-list-opt no-bdr">
                                                                        ...
                                                                        @if ($category->status == 0)
                                                                            <li><a href="#" data-toggle="modal"
                                                                                    data-target="#viewCategories-{{ $category->id }}"><em
                                            ...
                                            @php
                                                $category_pending = \App\Models\CategoriesPending::where(
                                                    'category_id',
                                                    $category->id,
                                                )
                                                    // ->where('action_type', '=', 'Edit')
                                            ...
                                            <div class="modal fade" id="viewCategories-{{ $category->id }}" role="dialog">
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        <a href="#" class="close" data-dismiss="modal">
                                                            <em class="icon ni ni-cross-sm"></em>
                                                        ...
                                                        <div class="modal-body modal-body-md">
                                                            ...
                                                            <form id="editForm-{{ $category->id }}" method="POST"
                                                                action="{{ route('userUpdate', $category->id) }}"
                                                                enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="tab-content">
                                                                    <div class="tab-pane active" id="infomation">
                                                                        <div class="row gy-4">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input disabled type="text"
                                                                                        ...
                                                                                        name="name"
                                                                                        value="{{ optional($category_pending)->name ?? 'N/A' }}"
                                                                                        required />
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    <label class="form-label"
                                                                                        for="lead-name">Description</label>
                                                                                    <div class="form-control-wrap">
                                                                                        <textarea disabled required class="form-control" name="description">{{ optional($category_pending)->description ?? 'N/A' }}</textarea>
                                                                                        {{-- <textarea required name="description" class="form-control no-resize" id="default-textarea">
                                                                            ...
                                                                            <div class="col-12">
                                                                                <label class="form-label"
                                                                                    for="lead-name">Display On Menu</label>
                                                                                <div class="form-control-wrap">
                                                                                    <select disabled class="form-control"
                                                                                        name="display_on_menu">

                                                                                        <option value="1"
                                                                                            {{ optional($category_pending)->display_on_menu == 1 ? 'selected' : '' }}>
                                                                                            Active</option>
                                                                                        <option value="0"
                                                                                            {{ optional($category_pending)->display_on_menu == 0 ? 'selected' : '' }}>
                                                                                            Inactive</option>
                        ...
                        <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                            ...
                            <tbody>
                                @foreach ($subcategories as $subcategory)
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <ul class="link-list-opt no-bdr">
                                                                ...
                                                                @if ($subcategory->status == 0)
                                                                    ...
                                                                    <li>
                                                                        <a href="#" data-toggle="modal"
                                                                            data-target="#viewSubCate-{{ $subcategory->id }}">
                                                                            <em class="icon ni ni-edit"></em><span>View
                                                                                Changes</span>
                                                                        </a>
                                                                    </li>
                                                                @endif
                                    ...
                                    @php
                                        $subcategory_pending = \App\Models\SubCategoryPending::with('category')
                                    ...
                                    <div class="modal fade" id="viewSubCate-{{ $subcategory->id }}" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                <a href="#" class="close" data-dismiss="modal">
                                                    <em class="icon ni ni-cross-sm"></em>
                                                            ...
                                                            <div class="row gy-4">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input disabled type="text" class="form-control"
                                                                            id="lead-name" name="name"
                                                                            value="{{ $subcategory_pending ? $subcategory_pending->name : 'N/A' }}" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <label for="lead-name"
                                                                            class="form-label">Category</label>
                                                                        <input disabled type="text" class="form-control"
                                                                            id="lead-category" name="category"
                                                                            value="{{ optional($subcategory_pending)->category ? $subcategory_pending->category->name : 'N/A' }}" />
                                                                    </div>
                                                                </div>
                        ...
                        <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                            ...
                            <tbody>
                                @foreach ($entities as $entity)
                                                            ...
                                                            <ul class="link-list-opt no-bdr">
                                                                ...
                                                                @if ($entity->status == 0)
                                                                    @can('entity-approve')
                                                                        ...
                                                                        <li><a href="#" data-toggle="modal"
                                                                                data-target="#viewEntity-{{ $entity->id }}"><em
                                                                                    class="icon ni ni-cross-circle-fill"></em><span>View</span></a>
                                                                        </li>
                                                                    @endcan
                                    ...
                                    @php
                                        $entity_pending = \App\Models\EntityPending::where('entity_id', $entity->id)
                                            // ->where('action_type', '=', 'Edit')
                                            ->latest()
                                            ->first();
                                    @endphp

                                    <div class="modal fade" id="viewEntity-{{ $entity->id }}" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                <a href="#" class="close" data-dismiss="modal">
                                                    <em class="icon ni ni-cross-sm"></em>
                                                ...
                                                <div class="modal-body modal-body-md">
                                                    ...
                                                    <form id="editForm-{{ $entity->id }}" method="POST"
                                                        action="{{ route('userUpdate', $entity->id) }}"
                                                        enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="tab-content">
                                                            <div class="tab-pane active" id="infomation">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input disabled type="text"
                                                                                class="form-control" id="lead-name"
                                                                                name="name"
                                                                                value="{{ optional($entity_pending)->name ?? 'N/A' }}"
                                                                                required />
                                                                        </div>
                                                                    </div>
                        ...
                        <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    ...
                                    @php
                                        $user_pending = \App\Models\UsersPending::where('user_id', $user->id)
                                            // ->where('action_type', '=', 'Edit')
                                            ->latest()
                                            ->first();
                                    @endphp

                                    <div class="modal fade" id="viewUser-{{ $user->id }}" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                <a href="#" class="close" data-dismiss="modal">
                                                    <em class="icon ni ni-cross-sm"></em>
                                                ...
                                                <div class="modal-body modal-body-md">
                                                    ...
                                                    <div class="tab-content">
                                                            ...
                                                            <div class="row gy-4">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input disabled type="text" class="form-control"
                                                                            id="lead-name" name="name"
                                                                            value="{{ optional($user_pending)->name ?? 'N/A' }}"
                                                                            required />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input disabled type="text" class="form-control"
                                                                            id="open-deal" name="email"
                                                                            value="{{ optional($user_pending)->email ?? 'N/A' }}"
                                                                            required />
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select disabled name="group_id"
                                                                            ...
                                                                            @foreach ($user_groups as $group)
                                                                                <option
                                                                                    {{ optional($user_pending)->group_id == $group->id ? 'selected' : '' }}>
                                                                                    {{ $group->name }}
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                        ...
                                                        {{ implode(', ', json_decode(optional($user_pending)->roles ?? '[]')) }}
                                                    </textarea>
                                                                    </div>
                                                                </div>
