                    ...
                    <div class="col-md-4">
                        <div class="float-end d-none d-md-block">
                            <div class="dropdown">
                                ...
                                data-bs-target="#addpermission" aria-expanded="true">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @can('role-edit')
                                                    ...
                                                    data-bs-target="#editoermission-{{$permission->id}}">Edit</a>
                                                @endcan
                                                
                                                @can('role-delete')
                                                <a class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#deletepermission-{{$permission->id}}">Delete</a>
                                                @endcan
                                            </td>
                                        </tr>
                                    @endforeach
...
<!-- ADD MODAL -->
<div class="modal fade" id="addpermission" data-bs-backdrop="static"
data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
aria-hidden="true">
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">Add Permission
            </h5>
...
<!-- EDIT MODAL -->
@foreach ($data as $key => $permission)
<div class="modal fade" id="editoermission-{{ $permission->id}}"
data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
aria-hidden="true">
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">{{ $permission->name}}
            </h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal"
                aria-label="Close"></button>
        </div>
...
<!-- DELETE MODAL -->
@foreach ($data as $key => $permission)
<div class="modal fade" id="deletepermission-{{ $permission->id}}"
data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
aria-hidden="true">
<div class="modal-dialog">
    <div class="modal-content">
