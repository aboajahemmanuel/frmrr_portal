...
@section('content')
    ...
    <!-- content @s -->
                                            ...
                                            @foreach ($data as $key => $permission)
                                                <tr class="nk-tb-item">
                                                    ...
                                                    <td class="nk-tb-col nk-tb-col-tools">
                                                                ...
                                                                <div class="drodown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        ...
                                                                        <ul class="link-list-opt no-bdr">
                                                                            @if ($permission->status == 1 || $permission->status == 2)
                                                                                @can('permission-edit')
                                                                                    <li>
                                                                                        <a href="#" data-toggle="modal"
                                                                                            data-target="#editGroup-{{ $permission->id }}">
                                                                                            <em
                                                                                ...
                                                                                @can('permission-delete')
                                                                                    <li><a href="#" data-toggle="modal"
                                                                                            data-target="#deleteGroup-{{ $permission->id }}"><em
                                                                            ...
                                                                            @if ($permission->status == 0)
                                                                                @can('permission-approve')
                                                                                    <li><a href="#" id="submit"
                                                                                            onclick="document.getElementById('approve-{{ $permission->id }}').submit();"><em
                                                                                                class="icon ni ni-check-round-fill"></em><span>Approve</span></a>
                                                                                    </li>
                                                                                @endcan


                                                                                @can('permission-reject')
                                                                                    <li><a href="#" data-toggle="modal"
                                                                                            data-target="#reject-{{ $permission->id }}"><em
                                                                            ...
                                                                            @if ($permission->status == 3)
                                                                                ...
                                                                                @endcan
                                                                                <form id="delete_request-{{ $permission->id }}"
                                                                                    action="{{ route('permissionstatus', $permission->id) }}"
                                                        ...
                                                        <div class="modal fade" permission="dialog"
                                                            id="reject-{{ $permission->id }}">
                                                                                            ...
                                                                                            <ul
                                                                                                ...
                                                                                                <li>
                                                                                                    <button
                                                                                                        ...
                                                                                                        id="rejectSubmitBtn-{{ $permission->id }}"
                                                                                                        type="submit">
                                                                                                    ...
                                                                                                    <script>
                                                                                                        ...
                                                                                                        document.addEventListener('DOMContentLoaded', function() {
                                                                                                            document.getElementById('rejectForm-{{ $permission->id }}').addEventListener('submit', function(
                                                                                                            event) {
                                                                                                                if (this.checkValidity() === false) {
                                                                                                                    event.preventDefault();
                                                                                                                    event.stopPropagation();
                                                                                                                } else {
                                                                                                                    loading('rejectSubmitBtn-{{ $permission->id }}');
                                                                                                                    document.getElementById('rejectSubmitBtn-{{ $permission->id }}').disabled = true;
                                                                                                                }
        ...
        @foreach ($data as $key => $permission)
            <div class="modal fade" permission="dialog" id="editGroup-{{ $permission->id }}">
                <div class="modal-dialog modal-dialog-centered modal-lg" permission="document">
                    <div class="modal-content">
                        <a href="#" class="close" data-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
                        <div class="modal-body modal-body-md">
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-label" for="lead-name">Permission Name</label>
                                                <div class="form-control-wrap">
                                                    <input required value="{{ $permission->name }}" name="name"
                                            ...
                                            <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                                <li>
                                                    <button class="btn btn-lg btn-primary btn-block"
                                                        id="editSubmitBtn-{{ $permission->id }}" type="submit">
                                                        <i class="fas fa-spinner fa-spin" style="display:none;"></i>
            ...
            <script>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    document.getElementById('editForm-{{ $permission->id }}').addEventListener('submit', function(event) {
                        if (this.checkValidity() === false) {
                            event.preventDefault();
                            event.stopPropagation();
                        } else {
                            loading('editSubmitBtn-{{ $permission->id }}');
                            document.getElementById('editSubmitBtn-{{ $permission->id }}').disabled = true;
                        }
                        this.classList.add('was-validated');
                    }, false);
                });
        ...
        @foreach ($data as $key => $permission)
                                ...
                                <div class="nk-modal py-4">
                                    ...
                                    <ul class="d-flex justify-content-center gx-4 mt-4">
                                        <li>
                                            ...
                                            <button id="deleteSubmitBtn-{{ $permission->id }}" type="submit" id="deleteOrg"
            ...
            <script>
                document.getElementById('deleteSubmitBtn-{{ $permission->id }}').addEventListener('click', function() {
                    loading('deleteSubmitBtn-{{ $permission->id }}');
                    setTimeout(() => {
                        document.getElementById('deleteSubmitBtn-{{ $permission->id }}').disabled = true;
                    }, 50);
                });
            </script>
        @endforeach
