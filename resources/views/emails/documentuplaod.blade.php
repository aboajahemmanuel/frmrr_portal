                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">We would like to inform you that the {{$doc_name}}  has been uploaded and is now awaiting your review and approval.</p>
                                    <p style="margin-bottom: 10px;">Please <a href="{{ url('login') }}">log in</a> to access and review the details.</p>
