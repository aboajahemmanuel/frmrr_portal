                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;"> We would like to inform you that the <b>{{$doc_name}}</b> recently submitted to the Financial Markets Regulations & Rules Repository Portal has been rejected.</p>
                                    ...
                                    <p style="margin-bottom: 10px;">To access further details, please <a href="{{ url('login') }}">log in</a>  to your account.</p>

                                
                                    <p style="margin-bottom: 10px;"> Thank you for your attention to this matter.</p>
