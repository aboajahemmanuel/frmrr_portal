                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">Thank you for registering on the FMDQ
                                        Financial Markets Regulations & Rules Repository Portal. Please click on the
                                        link below to verify your email address and activate your account.</p>

                                    <a href="{{ url('/user/verify/' . $user->verifyUser->token) }}"
                                        style="background-color:#ad8e4f;border-radius:4px;color:#ffffff;display:inline-block;font-size:13px;font-weight:600;line-height:44px;text-align:center;text-decoration:none;text-transform: uppercase; padding: 0 30px">Verify
                                        Email</a>
                                </td>
                            </tr>
