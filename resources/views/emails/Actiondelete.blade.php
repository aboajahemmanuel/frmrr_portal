                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;"> We would like to inform you that
                                        <b>({{ $action }})</b> has been deleted.
                                    </p>


                                    <br>

                                    <p style="margin-bottom: 10px;">To access further details, please <a
                                            href="{{ url('login') }}">log in</a> to your account.</p>
