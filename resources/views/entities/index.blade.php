...
@section('content')
    ...
    <!-- content @s -->
                        ...
                        <div class="nk-block-head nk-block-head-sm">
                            <div class="nk-block-between">
                                <div class="nk-block-head-content">
                                    <h3 class="nk-block-title page-title">Entities</h3>
                                                                ...
                                                                <div class="drodown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        ...
                                                                        <ul class="link-list-opt no-bdr">
                                                                            @if ($entity->admin_status == 1 || $entity->admin_status == 2)
                                                                                @can('entity-edit')
                                                                                    <li>
                                                                            ...
                                                                            @if ($entity->admin_status == 0)
                                                                                ...
                                                                                <li><a href="#" data-toggle="modal"
                                                                                        data-target="#viewUser-{{ $entity->id }}"><em
        ...
        <div class="modal fade" role="dialog" id="addUser">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body modal-body-md">
                        <h5 class="title">Add Entity</h5>
                        <form id="entityForm" method="POST" action="{{ route('entities.store') }}">
                            @csrf
                            <div class="tab-content">
                                <div class="tab-pane active" id="infomation">
                                    <div class="row gy-4">
        ...
        @foreach ($data as $entity)
            <div class="modal fade" role="dialog" id="editGroup-{{ $entity->id }}">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        <a href="#" class="close" data-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
                        <div class="modal-body modal-body-md">
                            <h5 class="title">Edit Entity</h5>
                            <form id="editForm-{{ $entity->id }}" method="POST"
                                action="{{ route('entityUpdate', $entity->id) }}" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="row gy-4">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="lead-name">Name</label>
                                                    <div class="form-control-wrap">
                                                        <input value="{{ $entity->name }}" name="name" type="text"
                                            ...
                                            <input value="0" hidden name="status" type="text" class="form-control"
                                                id="lead-name">
                                                ...
                                                <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                                    <li>
                                                        ...
                                                        <button class="btn btn-lg btn-primary btn-block"
                                                            id="editSubmitBtn-{{ $entity->id }}" type="submit">
                                                            <i class="fas fa-spinner fa-spin" style="display:none;"></i>
            ...
            <script>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    document.getElementById('editForm-{{ $entity->id }}').addEventListener('submit', function(event) {
                        if (this.checkValidity() === false) {
                            event.preventDefault();
                            event.stopPropagation();
                        } else {
                            loading('editSubmitBtn-{{ $entity->id }}');
                            document.getElementById('editSubmitBtn-{{ $entity->id }}').disabled = true;
                        }
                        this.classList.add('was-validated');
                    }, false);
                });
        ...
        <!-- @@  Delete Modal @e -->
        @foreach ($data as $entity)
            <div class="modal fade" id="deleteGroup-{{ $entity->id }}">
                                ...
                                <form method="POST" action="{{ route('deleteEntity', $entity->id) }}">
                                    ...
                                    <ul class="d-flex justify-content-center gx-4 mt-4">
                                        <li>
                                            ...
                                            <button id="deleteSubmitBtn-{{ $entity->id }}" type="submit" id="deleteOrg"
                                                class="btn btn-success">Yes, Delete
                                                it</button>


                                            {{-- <button type="submit" id="deleteOrg" class="btn btn-success"></button> --}}
                                </form>
            ...
            <script>
                document.getElementById('deleteSubmitBtn-{{ $entity->id }}').addEventListener('click', function() {
                    loading('deleteSubmitBtn-{{ $entity->id }}');
                    setTimeout(() => {
                        document.getElementById('deleteSubmitBtn-{{ $entity->id }}').disabled = true;
                    }, 50);
                });
            </script>
        @endforeach
        ...
        @foreach ($data as $entity)
            ...
            <div class="modal fade" id="viewUser-{{ $entity->id }}" role="dialog">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input disabled type="text" class="form-control" id="lead-name"
                                                    name="name" value="{{ optional($entity_pending)->name ?? 'N/A' }}"
                                                    required />
                                            </div>
                                        </div>
